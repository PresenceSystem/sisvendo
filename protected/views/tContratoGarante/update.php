...
$this->breadcrumbs=array(
	...
	Yii::t('app', $model->id_cont_garante) => array('view', 'id'=>$model->id_cont_garante),
...
$this->menu=array(
	...
	//array('label' => Yii::t('AweCrud.app', 'View'), 'icon' => 'eye-open', 'url'=>array('view', 'id' => $model->id_cont_garante)),
...
<fieldset>
    <legend><?php echo Yii::t('AweCrud.app', 'Update') . ' ' . TContratoGarante::label(); ?> <?php echo CHtml::encode($model) ?></legend>
