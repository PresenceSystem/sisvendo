...
$this->menu=array(
  ...
  //  array('label' => Yii::t('AweCrud.app', 'Create') . ' ' . Usuario::label(), 'icon' => 'plus', 'url' => array('create')),
	array('label' => Yii::t('AweCrud.app', 'Update'), 'icon' => 'pencil', 'url' => array('updateEstudiante', 'id' => $model->id)),
...
<img src='<?php echo "/sisbiblio/images/fotos/estudiante/".$model->foto;?>' border=0 style="border:0;margin:0;padding:0" width="100px" /><br>
