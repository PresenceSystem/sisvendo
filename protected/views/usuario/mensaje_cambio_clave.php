...
<fieldset>
    <?php echo Yii::app()->getSession()->get('nombre_usuario_sisplamV1'); ?> a cambiado su clave de acceso al sistema, los cambios tendrá efecto en el proximo inicio de sesión.
    <br>
