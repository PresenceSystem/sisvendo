    ...
    <?php echo $form->errorSummary($model) ?>
     ...
     <?php //echo $form->textFieldRow($model, 'foto', array('class' => 'span5', 'maxlength' => 200)) ?>
                                ...
                                <?php if ($model->isNewRecord != '1') { ?>
                                   ...
                                   <?php echo CHtml::image(Yii::app()->request->baseUrl . '/images/fotos/bibliotecario/' . $model->foto, "...", array("width" => 100)); ?>  
                        ...
                        <?php //echo $form->dropDownListRow($model, 'Rol', array('2'=>'Bibliotecario'));  ?>
