...
$this->breadcrumbs=array(
	...
	Yii::t('app', $model->id_articulo) => array('view', 'id'=>$model->id_articulo),
...
$this->menu=array(
	...
	//array('label' => Yii::t('AweCrud.app', 'View'), 'icon' => 'eye-open', 'url'=>array('view', 'id' => $model->id_articulo)),
...
<fieldset>
    <legend><?php echo Yii::t('AweCrud.app', 'Update') . ' ' . TArticulo::label(); ?> <?php echo CHtml::encode($model) ?></legend>
