<div class="form">
    ...
    <?php echo $form->errorSummary($model) ?>
                           ...
                           <?php echo $form->textFieldRow($model, 'ci_ruc', array('class' => 'span2', 'maxlength' => 13)) ?>
                        ...
                        <?php echo $form->textAreaRow($model, 'direccion', array('class' => 'span5', 'maxlength' => 100)) ?>
                        <?php echo $form->textFieldRow($model, 'cue_banc_prov', array('class' => 'span5', 'maxlength' => 100)) ?>
