...
<div class="text-center alert-error span9"> 
    <h3>
    <?php 
     $hoy_com = date("Y-m-d");
     $fecha_com = $model->fecha_creacion;
    if ($model->saldo==0 and $hoy_com==$fecha_com)
    {?>
       <?php 
       $this->widget('bootstrap.widgets.TbButtonGroup', array(
                                        ...
                                        'size' => '50px',
                                        'buttons' => array(
            array('label' => Yii::t('AweCrud.app', 'ELIMINAR CONTRATO'), 'icon' => 'trash', 'url' => '#', 'linkOptions' => array('submit' => array('delete', 'id' => $model->numero), 'confirm' => Yii::t('AweCrud.app', 'Are you sure you want to delete this item?'))),
            )));
       
       ?> 
        , o continuar llenando. <br> NOTA: Es obligatorio los items 3, y 4.
 <?php 
    }; //fin de eliminar el contrato
    ?>
...
//        ));
    ...
    <div class="fondoColor">
        <table class="table table-bordered table-condensed"> 
            ...
            <tbody>
                <tr>
                    <td><?php echo "<b>Nombres y Apellidos: </b>" . CHtml::link($model->idDeudor->nombre, array('/tPersona/update', 'id' => $model->idDeudor->ci)) . "</td><td><b> CI: </b>" . CHtml::encode($model->idDeudor->ci); ?></td>
                </tr>
                <tr>
    ...
    <div class="fondoColor">
        <table class="table table-bordered table-condensed"> 
            ...
            <tbody>
                ...
                <center><?php echo 'GARANTE '.strtoupper($gar->tipo).'  N°.' . $contador_garantes++; ?></center>
                </td>
                </tr>
                <tr>
                    <td>
                        <?php //echo "<b>Nombres y Apellidos: </b>" . CHtml::encode($gar->idGarante->nombre) . "</td><td><b> CI: </b>" . CHtml::encode($gar->idGarante->ci); 
                         echo "<b>Nombres y Apellidos: </b>" . CHtml::link($gar->idGarante->nombre, array('tContratoGarante/update',
                                     'id' => $gar->id_cont_garante)) . "</td><td><b> CI: </b>" . CHtml::encode($gar->idGarante->ci);
                        ?>
            ...
            <tr>
                <td>
                  ...
                  <center>  <?php echo CHtml::button('Buscar garante en la base de datos', array('onclick' => '$("#mymodalBuscar").dialog("open");return false;')); ?></center>
                   ...
                   <center> <?php echo CHtml::button('Ingresar nuevo garante', array('onclick' => '$("#mymodal").dialog("open");return false;')); ?> </center>
                    <!--Fin añadir nuevo garante-->
                </td>
            </tr>
            </tbody>
        ...
        <table class="table table-bordered table-condensed"> 
            ...
            <tbody>
                ...
                <tr>
                    <td colspan="8"> 
                        <br><br><br>
                        <center> <?php echo CHtml::button('Añadir nuevo artículo', array('onclick' => '$("#mymodal_articulo").dialog("open");return false;')); 
                        ?> </center>
                        <!--Fin añadir nuevo garante--></td>
                </tr>       
            </tbody> 
        </table>
    </div>
                ...
                <tr>
                    <td colspan="2" >                        
                            ...
                            $this->widget('bootstrap.widgets.TbButtonGroup', array(
                                        ...
                                        'size' => '50px',
                                        'buttons' => array(
                                             array('label' => 'MODIFICAR FORMA DE PAGO', 'icon' => 'cash', 'url' => array('/tContrato/actualizar/'.$model->numero))
...
echo $this->renderPartial('/tCuota/_form_flotante', array(
    'model' => $model_cuota
));
$this->endWidget('zii.widgets.jui.CJuiDialog');
?>
        ...
        <br><br><br>
       <center> <?php echo CHtml::button('Añadir nueva cuota', array('onclick' => '$("#mymodal_cuota").dialog("open");return false;')); 
        ?> </center>
    ...
    <div class="fondoColor">
<?php
$imghtml = CHtml::image(Yii::app()->baseUrl . "/images/pagina/imp_pdf.png");
echo '<center>' . CHtml::link($imghtml, array('pdf', 'id' => $model->numero), array('target' => '_blank')) . '</center>';
?>
    </div>
</fieldset>
