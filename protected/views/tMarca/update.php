...
$this->breadcrumbs=array(
	...
	Yii::t('app', $model->id_marca) => array('view', 'id'=>$model->id_marca),
...
$this->menu=array(
	...
	//array('label' => Yii::t('AweCrud.app', 'View'), 'icon' => 'eye-open', 'url'=>array('view', 'id' => $model->id_marca)),
...
<fieldset>
    <legend><?php echo Yii::t('AweCrud.app', 'Update') . ' ' . TMarca::label(); ?> <?php echo CHtml::encode($model) ?></legend>
