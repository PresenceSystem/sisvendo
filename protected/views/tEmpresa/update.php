...
$this->breadcrumbs=array(
	...
	Yii::t('app', $model->id_empresa) => array('view', 'id'=>$model->id_empresa),
...
$this->menu=array(
	...
	//array('label' => Yii::t('AweCrud.app', 'View'), 'icon' => 'eye-open', 'url'=>array('view', 'id' => $model->id_empresa)),
...
<fieldset>
    <legend><?php echo Yii::t('AweCrud.app', 'Update') . ' ' . TEmpresa::label(); ?> <?php echo CHtml::encode($model) ?></legend>
