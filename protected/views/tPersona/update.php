...
$this->breadcrumbs=array(
	...
	Yii::t('app', $model->ci) => array('view', 'id'=>$model->ci),
...
$this->menu=array(
	...
	//array('label' => Yii::t('AweCrud.app', 'View'), 'icon' => 'eye-open', 'url'=>array('view', 'id' => $model->ci)),
...
<fieldset>
    <legend><?php echo Yii::t('AweCrud.app', 'Update') . ' ' . TPersona::label(); ?> <?php echo CHtml::encode($model) ?></legend>
