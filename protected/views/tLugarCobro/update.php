...
$this->breadcrumbs=array(
	...
	Yii::t('app', $model->id_lugar) => array('view', 'id'=>$model->id_lugar),
...
$this->menu=array(
	...
	//array('label' => Yii::t('AweCrud.app', 'View'), 'icon' => 'eye-open', 'url'=>array('view', 'id' => $model->id_lugar)),
...
<fieldset>
    <legend><?php echo Yii::t('AweCrud.app', 'Update') . ' ' . TLugarCobro::label(); ?> <?php echo CHtml::encode($model) ?></legend>
