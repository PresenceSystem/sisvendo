...
/**
 * AweCoreHelper is a static class that provides a collection of helper methods for code generation.
 *
 * @author Ricardo Obregón <ricardo@obregon.co>
 * @package AweCrud.helpers
 */
class AweCoreHelper
{
    ...
    public static function ArrayToPhpSource($array, $indent = 1, $empty = 'array()')
    {
        ...
        foreach ($array as $key => $value) {
            ...
            if (is_int($key)) {
                ...
                {
                    throw new InvalidArgumentException(Yii::t('AweCrud.messages', 'Array key type not supported.'));
                }
            }
